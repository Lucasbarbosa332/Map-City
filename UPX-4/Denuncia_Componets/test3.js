...
/**************************/
  ...
  // Gera a inicial do e-mail para o avatar
  ...
  // Exibe o modal de confirmação quando o usuário tenta sair
window.onbeforeunload = function (event) {
    event.preventDefault();  // Impede a navegação ou fechamento imediato
...
// Função para fechar o modal e continuar
function closeModal() {
    const modal = document.getElementById('confirmationModal');
...
document.getElementById('confirmExit').addEventListener('click', function() {
    window.close();  // Fecha a janela ou página
});

// Ação de cancelar saída
document.getElementById('cancelExit').addEventListener('click', function() {
    closeModal();  // Fecha o modal e permanece na página
});
